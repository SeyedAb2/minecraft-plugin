...
public class Game {
    ...
    private Location[][] gameBoard = new Location[3][3];
    ...
    public void createBoard(Player player1){
        ...
        for (int i=2;i>-1;i--){
            for (int j=-1;j<2;j++){
                this.gameBoard[i][j+1] = new Location(world,x+j,y+i,z-5);
            }
        }
    }
    ...
    public void placePiece(int pos, Player player) {
        ...
        positionPlayerBlock(pos,playerBlock);
    ...
    public void loadPlacePiece(ArrayList<Integer> player1Positions, ArrayList<Integer> player2Positions) {
        for (Integer player1Position : player1Positions) {
            ...
            positionPlayerBlock(player1Position,playerBlock);
        }
        for (Integer player2Position : player2Positions) {
            Material playerBlock = Material.RED_WOOL;
            positionPlayerBlock(player2Position,playerBlock);
        }
        ...
        for (Integer emptyPos : emptyPositions) {
            ...
            positionPlayerBlock(emptyPos,playerBlock);
        }
    }
    ...
    public void save(Player player) {
        ...
        String url = "jdbc:mysql://localhost:3306/xogame";
        String uname = "root";
        String password = "";
    ...
    public void positionPlayerBlock(int pos , Material playerBlock){
        switch (pos) {
            case 1:
                gameBoard[2][0].getBlock().setType(playerBlock);
                break;
            case 2:
                gameBoard[2][1].getBlock().setType(playerBlock);
                break;
            case 3:
                gameBoard[2][2].getBlock().setType(playerBlock);
                break;
            case 4:
                gameBoard[1][0].getBlock().setType(playerBlock);
                break;
            case 5:
                gameBoard[1][1].getBlock().setType(playerBlock);
                break;
            case 6:
                gameBoard[1][2].getBlock().setType(playerBlock);
                break;
            case 7:
                gameBoard[0][0].getBlock().setType(playerBlock);
                break;
            case 8:
                gameBoard[0][1].getBlock().setType(playerBlock);
                break;
            case 9:
                gameBoard[0][2].getBlock().setType(playerBlock);
                break;
        }
    }
}
